		...
		<div class="white-wrapper">
			<div class="container lead">
					...
					<div class="pull-right">
						<a onclick="$('.addvideoform').toggle();" class="btn btn-info">Add Testimonial</a>
					</div>
							...
							<form method="POST">
								<div class="col-md-12">
									<div class="form-group">
										<input required type="text" name="title" class="form-control" Placeholder="Title/ Author for Testimonial" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<textarea required name="description" class="form-control" Placeholder="Content for Testimonial"></textarea>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
								...
								if(empty($alltestimonials))
									{
										echo	"
													<div class='alert alert-info'>
														<b> Error! </b> There is no Testimonial on the site.
													</div>
												";
									} else {
										?>
													...
													?>
														<td>
															<form method="POST" onsubmit="return confirmdelete();">
																...
																<input type="submit" class="btn btn-danger" name="submit" value="Delete Testimonial <?php echo $single['id']; ?>" />
															</form>
														</td>
													<?php
												echo "</tr>";
