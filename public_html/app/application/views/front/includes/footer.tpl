...
<div id="copyrights" style='display:none;'>
  ...
  <!-- Main Scripts-->
  <script src="<?php echo base_url()."assets/front/" ?>js/sjainventures.js"></script> 
  <script src="<?php echo base_url()."assets/front/" ?>js/admin.js"></script> 
  <script src="<?php echo base_url()."assets/front/" ?>js/samtab.js"></script> 
