...
?> 
	...
	<section class="post-wrapper jt-shadow clearfix">
		...
		<div class="container">
					...
					<br/>
					<div class="col-sm-12">
						<form method='GET' action="<?php echo base_url('building/visitors-logs');?>">
						<div class='col-sm-1'></div>
						<div class='col-sm-8'>
							<input type="text" name='searchkeyword' id="searchkeyword" placeholder="Search Visitors Log" class='form-control'>
						</div>	
						<div class='col-sm-2'>
